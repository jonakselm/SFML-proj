...
int main()
{
	...
	bool changedText = false;
		...
		auto &b16 = buttonHandler.addButton("Make screen small", [&]
			{
				window.create(sf::VideoMode(990, 650), "SFML Snake");
			});
		b16.setSelectionColour(sf::Color(0, 255, 255, 127));
		b16.setDeselectionColour(sf::Color(0, 255, 255, 127));
		b16.setTextSelectionColour(sf::Color::Green);
	...
	auto &k1 = keyHandler.addKey(sf::Keyboard::R, [&]
		{
			b1.invoke();
		});
	auto &k2 = keyHandler.addKey(sf::Keyboard::F, [&]
		{
			b11.invoke();
		});
	auto &k3 = keyHandler.addKey(sf::Keyboard::X, [&]
		{
			auto pos = sf::Mouse::getPosition(window);
